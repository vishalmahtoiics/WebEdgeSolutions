...
const PATHS = {
  ...
  shield: '<path d="M12 3 5 6v5.5c0 4.3 2.9 8.2 7 9.5 4.1-1.3 7-5.2 7-9.5V6Z"/><path d="m9.2 12 2 2 3.6-3.9"/>',
  receipt: '<path d="M5 3.5h14v17l-2.3-1.6-2.3 1.6-2.4-1.6L9.6 20.5 7.3 18.9 5 20.5Z"/><path d="M8.5 8.5h7"/><path d="M8.5 12.5h7"/>',
  lifebuoy: '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3.6"/><path d="m5.6 5.6 3.8 3.8"/><path d="m14.6 14.6 3.8 3.8"/><path d="m18.4 5.6-3.8 3.8"/><path d="m9.4 14.6-3.8 3.8"/>',
